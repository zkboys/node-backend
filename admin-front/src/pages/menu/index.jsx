...
export default class UserCenter extends Component {
    ...
    handleSubmit = (values) => {
        ...
        this.props.ajax.get('/menus', params)
            .then(res => {
    ...
    handleDelete = (id) => {
        ...
        this.props.ajax.del(`/menus/${id}`, null, {successTip: '删除成功！', errorTip: '删除失败！'})
    ...
    handleBatchDelete = () => {
        ...
        Modal.confirm({
            ...
            onOk: () => {
                this.setState({deleting: true});
                this.props.ajax.del('/menus', {ids: selectedRowKeys}, {successTip: '删除成功！', errorTip: '删除失败！'})
                    .then(() => this.form.submit())
                    .finally(() => this.setState({deleting: false}));
            },
        })
